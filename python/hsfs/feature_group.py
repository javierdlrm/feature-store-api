...
class FeatureGroupBase:
    ...
    def statistics(self):
        ...
        """
        self._check_statistics_support()  # raises an error if stats not supported
        print("[FeatureGroupBase] statistics attr")
    ...
    def get_statistics(
        ...
        """
        self._check_statistics_support()  # raises an error if stats not supported
        print("[FeatureGroupBase] get_statistics")
        return self._statistics_engine.get(
            self, computation_time=commit_time, feature_names=feature_names
        )
    ...
    def compute_statistics(self):
        ...
        if self.statistics_config.enabled:
            ...
            print("[FeatureGroupBase] compute_statistics")
...
class FeatureGroup(FeatureGroupBase):
    ...
    def compute_statistics(
        ...
        if self.statistics_config.enabled:
            if self._is_time_travel_enabled() or wallclock_time is not None:
                ...
                # to update the statistics.
                print(
                    "[FeatureGroup] compute_statistics. fg_commit_id: "
                    + str(fg_commit_id or "None")
                    + ", wallclock_time: "
                    + str(wallclock_time or "None")
                )
                return (
                    registered_stats
    ...
    def statistics(self):
        ...
        if self._is_time_travel_enabled():
            ...
            print("[FeatureGroup] statistics attr")
            return self._statistics_engine.get_by_time_window(
                self,
                start_time=None,
                end_time=now,
