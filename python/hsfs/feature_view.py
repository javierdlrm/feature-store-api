...
class FeatureView:
    ...
    def create_statistics_monitoring(
        ...
        # Arguments
            ...
            is_event_window: If true, use event time to compute statistics.
                Defaults to False.
    ...
    def statistics(
        ...
        start_time,
        end_time,
        is_event_window: Optional[bool] = False,
        ...
        # Arguments
            ...
            is_event_window: bool: Whether start and end times are event times or commit times. This parameter is optional. Default value is False.
            feature_names: str: Names of the features from which statistics where computed. This parameter is optional.
        ...
        """
        if is_event_window and computed_at is None:
            raise ValueError(
