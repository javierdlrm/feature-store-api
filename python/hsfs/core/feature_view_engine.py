...
class FeatureViewEngine:
    ...
    def create_training_dataset(
        ...
        print("[FeatureViewEngine] create_training_dataset")
    ...
    def recreate_training_dataset(
        ...
        print("[FeatureViewEngine] recreate_training_dataset")
        training_dataset_obj = self._get_training_data_metadata(
            feature_view_obj, training_dataset_version
        )

        if statistics_config is not None:
            print("[FeatureViewEngine] recreate_training_dataset - update stats config")
    ...
    def compute_training_dataset(
        ...
        print("[FeatureViewEngine] compute_training_dataset")
    ...
    def compute_training_dataset_statistics(
        ...
        if training_dataset_obj.statistics_config.enabled:
            print("[FeatureViewEngine] compute_training_dataset_statistics")
            if training_dataset_obj.splits:
