...
class Statistics:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._is_event_window = is_event_window
        # feature group and feature view
    ...
    def from_response_json(cls, json_dict):
        ...
        if "count" in json_decamelized:
            ...
            print(
                "[Statistics] from_response_json - returning a single stats obj (response single)"
            )
    ...
    def to_dict(self):
        _dict = {
            ...
            "isEventWindow": self._is_event_window,
    ...
    @property
    def is_event_window(self):
        return self._is_event_window
